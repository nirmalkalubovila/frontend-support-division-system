...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center gap-1 rounded-xl bg-[var(--background)] p-1 text-[var(--text-muted)]",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      "data-[state=active]:bg-[var(--surface)] data-[state=active]:text-[var(--primary-text)] data-[state=active]:shadow-sm",
      className
    )}
    {...props}
  />
